...
// Test pour vérifier que les commentaires système déclenchent le webhook WebSocket
...
echo "=== TEST COMMENTAIRES SYSTÈME WEBSOCKET ===\n\n";
...
$createParticipantResult = testEndpoint('POST', '/register', [
    'email' => 'participant@websocket.com',
    'password' => 'password123',
...
$sessionData = [
    ...
    'time' => '18:00',
    'location' => 'Tennis Club - Test WebSocket',
...
// 7. Accepter l'invitation (cela devrait déclencher le webhook)
echo "\n✅ ACCEPTATION INVITATION (DÉCLENCHEMENT WEBSOCKET)\n";
echo "==================================================\n";
...
if ($acceptResult['code'] === 200) {
    ...
    echo "   ✅ WebSocket event 'comment.created' devrait avoir été émis\n";
    echo "   ✅ Canal: sport-session." . $session['id'] . "\n";
} else {
...
if ($commentsAfterAcceptResult['code'] === 200) {
    ...
    if ($acceptCount > $initialCount) {
        ...
        echo "   - ID du commentaire: " . $lastComment['id'] . "\n";
    } else {
...
$sessionData2 = [
    ...
    'time' => '19:00',
    'location' => 'Stade - Test Refus WebSocket',
    'participantIds' => [$participantData['user']['id']]
];
...
// 10. Refuser l'invitation (cela devrait aussi déclencher le webhook)
echo "❌ REFUS INVITATION (DÉCLENCHEMENT WEBSOCKET)\n";
echo "=============================================\n";
...
if ($declineResult['code'] === 200) {
    ...
    echo "   ✅ WebSocket event 'comment.created' devrait avoir été émis\n";
    echo "   ✅ Canal: sport-session." . $session2['id'] . "\n";
} else {
...
echo "\n=== RÉSUMÉ WEBSOCKET ===\n";
echo "=======================\n";
echo "✅ Les commentaires système sont créés automatiquement\n";
echo "✅ Les événements WebSocket 'comment.created' sont émis\n";
echo "✅ Canal: sport-session.{sessionId}\n";
echo "✅ Données: {comment: {...}}\n";
echo "✅ Affichage en temps réel dans l'application\n";
